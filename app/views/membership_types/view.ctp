...
<h2><?php  __('Membership Type');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		...
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $membershipType['MembershipType']['title']; ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Membership Type', true), array('action' => 'edit', $membershipType['MembershipType']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('Delete Membership Type', true), array('action' => 'delete', $membershipType['MembershipType']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $membershipType['MembershipType']['id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($membershipType['Student'])):?>
	...
	<?php
		$i = 0;
		foreach ($membershipType['Student'] as $student):
			$class = null;
			if ($i++ % 2 == 0) {
				$class = ' class="altrow"';
			}
