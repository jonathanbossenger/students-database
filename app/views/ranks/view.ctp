...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Rank', true), array('action' => 'edit', $rank['Rank']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('Delete Rank', true), array('action' => 'delete', $rank['Rank']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $rank['Rank']['id'])); ?> </li>
...
<div class="related">
	...
	<?php
		$i = 0;
		foreach ($rank['Student'] as $student):
			$class = null;
			if ($i++ % 2 == 0) {
				$class = ' class="altrow"';
			}
