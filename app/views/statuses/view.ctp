...
<div class="related">
	...
	<?php
		$i = 0;
		foreach ($status['Student'] as $student):
			$class = null;
			if ($i++ % 2 == 0) {
				$class = ' class="altrow"';
			}
		...
		<tr<?php echo $class;?>>
			...
			<td><?php echo $student['graded_date'];?></td>
			...
			<td><?php echo $student['on_hold'];?></td>
