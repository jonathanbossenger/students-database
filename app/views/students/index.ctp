<div id="tab-navigation">
	<ul>
		<li id="selected"><?php echo $this->Html->link(__('Student', true), array('controller' => 'students', 'action' => 'index')); ?></li>
...
<div id="tab-content">
	...
	<div class="students index">
		...
		?>
		<tr<?php echo $class;?>>
			<td><?php echo $this->Html->link($student['Student']['first_name'], array('action' => 'edit', $student['Student']['id'])); ?>&nbsp;</td>
			<td><?php echo $this->Html->link($student['Student']['last_name'], array('action' => 'edit', $student['Student']['id'])); ?>&nbsp;</td>
			...
			<td><?php echo ($student['Student']['on_hold'] == 1 ? 'On Hold' : $student['Student']['cancellation_date'] ) ; ?>&nbsp;</td>
	...
	<div class="actions">
		...
		<ul>
			<li><?php echo $this->Html->link(__('Export to Excel', true), array('action' => 'export')); ?></li>
		</ul>
	</div>	
</div>